      ...
      <main className="max-w-7xl mx-auto px-6 w-full">
        ...
        <section className="flex flex-col-reverse lg:flex-row items-center justify-between py-16 lg:py-24 gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* NEW Social Proof: Verified Review */}
            <div className="mt-10 flex flex-col items-center lg:items-start gap-3">
              <div className="flex gap-1 text-[#1CD05D]">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                ))}
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 italic">
                &quot;It literally changed how I eat. No more 9 PM panic.&quot;
              </p>
              <p className="text-xs font-bold text-gray-900 dark:text-white">— Tishe O., Final Year Student</p>
            </div>
          </div>
        ...
        {/* 2. NEW Authority/Media Recognition Section (Replaces Stats) */}
        {/* <section className="py-12 border-y border-gray-200 dark:border-gray-800 my-12 bg-white/40 dark:bg-[#0A0A0A]/40 rounded-3xl">
          <div className="text-center mb-8">
            <p className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Recognized for transforming meal prep</p>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-10 md:gap-20 opacity-50 grayscale hover:grayscale-0 transition-all duration-500 cursor-default">
            {/* These are styled text elements mimicking brand logos. Replace with <Image> tags of real logos later if desired. */}
            {/* <div className="text-2xl font-black font-serif tracking-tighter text-gray-800 dark:text-white">TechCrunch</div>
            <div className="text-2xl font-bold tracking-widest text-gray-800 dark:text-white">FORBES</div>
            <div className="text-2xl font-semibold italic text-gray-800 dark:text-white">Healthline</div>
            <div className="text-2xl font-extrabold tracking-tight text-gray-800 dark:text-white">WIRED</div>
          </div>
        </section> */} 
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gray-900 dark:bg-[#0A1A12] border border-gray-800 dark:border-green-900/30 text-center px-6 py-16 lg:py-24">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-gray-300 mb-10">
                Join our community and start eating healthier while reducing food waste every single day.
              </p>
              <div className="flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-sm text-gray-400">Quick and easy setup • Join the community today</p>
              </div>
            </div>
          </div>
        </section>
