  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A0A0A] text-gray-900 dark:text-white pb-20 lg:pb-8 transition-colors duration-300">
      <main className="p-6 md:p-8 max-w-250 mx-auto w-full animate-in fade-in duration-500">
        ...
        {/* Back Button */}
        <button onClick={() => router.push('/dashboard')} className="text-[#1CD05D] text-sm font-bold flex items-center gap-2 mb-8 hover:underline w-max transition-all">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Profile Settings</h1>
          ...
          <div className="flex gap-4">
             <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 min-w-35 flex flex-col justify-center shadow-sm">
                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Target Budget</p>
                <div className="flex items-end gap-1">
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">₦{Number(budgetAmount).toLocaleString()}</p>
                  <span className="text-[10px] text-gray-500 mb-1 uppercase">/{budgetPeriod.slice(0,2)}</span>
                </div>
             </div>
             <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 min-w-30 flex flex-col justify-center shadow-sm">
        ...
        {/* Feedback Alert */}
        {feedback && (
          <div className={`p-4 mb-8 rounded-xl flex items-center gap-3 border shadow-sm animate-in slide-in-from-top-4 duration-300 ${
            feedback.type === 'success' 
              ? 'bg-green-50 dark:bg-linear-to-r dark:from-[#1CD05D]/20 dark:to-[#111111] border-green-200 dark:border-[#1CD05D]/30 text-green-700 dark:text-[#1CD05D]' 
              : 'bg-red-50 dark:bg-linear-to-r dark:from-red-500/20 dark:to-[#111111] border-red-200 dark:border-red-500/30 text-red-600 dark:text-red-400'
          }`}>
        ...
        <form onSubmit={handleSaveProfile} className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-2xl p-6 md:p-8 shadow-sm h-full">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-green-50 dark:bg-[#1A1A1A] flex items-center justify-center text-[#1CD05D]">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-[#1CD05D] dark:group-focus-within:text-[#1CD05D] transition-colors">
                      ...
                      <input 
                        ...
                        className="w-full py-3.5 pl-11 pr-4 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl text-gray-900 dark:text-white text-sm focus:border-[#1CD05D] focus:bg-white dark:focus:bg-[#111111] hover:border-gray-300 dark:hover:border-gray-600 outline-none transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                       ...
                       <span className="text-[9px] bg-gray-100 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 text-gray-500 px-2 py-0.5 rounded font-bold tracking-widest flex items-center gap-1">
                    ...
                    <div className="relative opacity-70 dark:opacity-60">
                      ...
                      <input 
                        ...
                        value={email}
                        disabled
                        className="w-full py-3.5 pl-11 pr-4 bg-transparent border border-dashed border-gray-300 dark:border-gray-700 rounded-xl text-gray-600 dark:text-gray-400 text-sm cursor-not-allowed"
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-2xl p-6 md:p-8 shadow-sm h-full flex flex-col">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-green-50 dark:bg-[#1A1A1A] flex items-center justify-center text-[#1CD05D]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 font-bold group-focus-within:text-[#1CD05D] dark:group-focus-within:text-[#1CD05D] transition-colors">
                        ₦
                      </div>
                      <input 
                        type="number" 
                        ...
                        placeholder="0"
                        min="0"
                        className="w-full py-3.5 pl-9 pr-4 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl text-gray-900 dark:text-white text-sm font-bold focus:border-[#1CD05D] focus:bg-white dark:focus:bg-[#111111] hover:border-gray-300 dark:hover:border-gray-600 outline-none transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      <select 
                        ...
                        className="w-full py-3.5 pl-11 pr-10 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl text-gray-900 dark:text-white text-sm focus:border-[#1CD05D] focus:bg-white dark:focus:bg-[#111111] hover:border-gray-300 dark:hover:border-gray-600 outline-none appearance-none transition-all cursor-pointer"
                      >
                ...
                <div className="mt-auto">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 dark:text-gray-500 group-focus-within:text-yellow-500 transition-colors">
                    ...
                    <input 
                      ...
                      className="w-full py-3.5 pl-11 pr-4 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl text-gray-900 dark:text-white text-sm focus:border-yellow-500 focus:bg-white dark:focus:bg-[#111111] hover:border-gray-300 dark:hover:border-gray-600 outline-none transition-all"
                    />
                  </div>
          ...
          {/* Bottom Action Bar */}
          <div className="pt-6 border-t border-gray-200 dark:border-[#2A2A2A] flex justify-end">
            <button 
              type="submit"
              disabled={isSaving}
