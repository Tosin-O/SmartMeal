      ...
      <main className="p-6 md:p-8 max-w-300 w-full animate-in fade-in duration-500">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            You&apos;re focusing on <span className="text-gray-900 dark:text-white font-medium">{userData?.primaryGoal}</span> this cycle. Let&apos;s check your progress.
          </p>
        </section>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          ...
          <div className="p-5 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-2xl transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#1CD05D]/5">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white">{totalMealPlans}</p>
          ...
          <div className="p-5 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-2xl transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#1CD05D]/5">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white">{pantryItemCount}</p>
            <p className="text-xs font-bold tracking-widest text-gray-500 uppercase mt-1">Pantry Items</p>
          </div>
          
          <div className="p-5 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] rounded-2xl col-span-2 transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#1CD05D]/5">
            <div className="flex justify-between items-start mb-3">
              ...
              {spentAmount > safeBudget ? (
                ...
                <span className="px-2 py-1 text-[10px] font-bold text-[#1CD05D] bg-green-100 dark:bg-[#13251A] rounded uppercase tracking-wider">On Budget</span>
              )}
            </div>
            <div className="flex items-end gap-2">
              <p className="text-2xl font-bold text-gray-900 dark:text-white">₦{spentAmount.toLocaleString()}</p>
        ...
        <section className="mb-10">
          ...
          {todaysMeals.length === 0 ? (
            <div className="p-8 bg-white dark:bg-[#111111] border border-dashed border-gray-300 dark:border-[#2A2A2A] rounded-2xl flex flex-col items-center justify-center text-center">
              <svg className="w-10 h-10 text-gray-400 dark:text-gray-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
              <p className="text-gray-900 dark:text-white font-bold mb-1">No meals scheduled for today</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {todaysMeals.map((meal) => (
                <div key={meal.id} className={`p-5 border rounded-2xl flex flex-col ${meal.isEaten ? 'bg-gray-100 dark:bg-[#0A0A0A] border-gray-200 dark:border-[#2A2A2A] opacity-60' : 'bg-white dark:bg-[#111111] border-gray-200 dark:border-[#2A2A2A]'}`}>
                  <p className="text-xs font-bold tracking-widest text-gray-500 uppercase mb-4">{meal.mealType}</p>
                  <h3 className={`text-lg font-bold mb-1 ${meal.isEaten ? 'text-gray-500 dark:text-gray-400 line-through' : 'text-gray-900 dark:text-white'}`}>{meal.title}</h3>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Handy tools to manage your meals and inventory.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-linear-to-br from-[#1CD05D]/10 to-white dark:from-[#1CD05D]/20 dark:to-[#111111] border border-[#1CD05D]/30 rounded-2xl p-6 flex flex-col justify-between group transition-all duration-300">
              <div>
                ...
                <h3 className="text-gray-900 dark:text-white font-bold text-lg mb-2">Check Groceries</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Review your automatically generated shopping list before heading to the market.</p>
              </div>
            ...
            <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] hover:border-[#1CD05D]/50 rounded-2xl p-6 flex flex-col justify-between group transition-all duration-300">
              <div>
                <div className="w-10 h-10 bg-gray-100 dark:bg-[#1A1A1A] rounded-xl flex items-center justify-center text-gray-500 dark:text-gray-400 group-hover:text-[#1CD05D] group-hover:bg-[#1CD05D]/10 mb-4 transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>
                </div>
                <h3 className="text-gray-900 dark:text-white font-bold text-lg mb-2">My Pantry</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Update your current ingredients to keep your AI recommendations accurate.</p>
              </div>
              <button onClick={() => router.push('/dashboard/pantry')} className="mt-6 w-full py-2.5 text-gray-600 dark:text-gray-400 font-bold text-xs uppercase tracking-widest rounded-lg border border-gray-200 dark:border-[#2A2A2A] group-hover:bg-[#1CD05D] group-hover:text-black group-hover:border-[#1CD05D] transition-colors">
                Manage Pantry
              </button>
            </div>
            ...
            <div className="bg-white dark:bg-[#111111] border border-gray-200 dark:border-[#2A2A2A] hover:border-[#1CD05D]/50 rounded-2xl p-6 flex flex-col justify-between group transition-all duration-300">
              <div>
                ...
                <h3 className="text-gray-900 dark:text-white font-bold text-lg mb-2">Meal Planner</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">Adjust your budget, tweak your diet goals, and plan the upcoming week.</p>
              </div>
              <button onClick={() => router.push('/dashboard/meal-plan')} className="mt-6 w-full py-2.5 text-gray-600 dark:text-gray-400 font-bold text-xs uppercase tracking-widest rounded-lg border border-gray-200 dark:border-[#2A2A2A] group-hover:bg-[#1CD05D] group-hover:text-black group-hover:border-[#1CD05D] transition-colors">
                Open Planner
              </button>
            </div>
